...
//	}
    ...
    * @return
    */
   public static double getFormatRate2(double one,double two,int num){
	   BigDecimal a= new BigDecimal(one);
	   BigDecimal b= new BigDecimal(two);
	   BigDecimal c = a.divide(b,num,BigDecimal.ROUND_DOWN);
	   return c.doubleValue();
   } 
...
public static  int getAge(String birthDayStr) throws Exception {
	Date birthDay = parse(birthDayStr);
 ...
 */
public static String getBeforeYear(String startYear) throws ParseException {
	SimpleDateFormat sdf= new SimpleDateFormat("yyyy");
	Date date=new Date();// 取时间
	Calendar calendar = Calendar.getInstance(); 
	calendar.setTime(sdf.parse(startYear)); 
 ...
 * @throws ParseException
 */
public static String getBrforeMonth(String startMoth) throws ParseException {
	SimpleDateFormat sdf= new SimpleDateFormat("yyyy-MM");
	Date date=new Date();// 取时间
	Calendar calendar = Calendar.getInstance(); 
	calendar.setTime(sdf.parse(startMoth)); 
	calendar.add(Calendar.MONTH, -1);
	date=calendar.getTime();
	startMoth = sdf.format(date);
	return startMoth;
}
 ...
 * @throws ParseException
 */
public static String getBrforeDate(String startDate) throws ParseException {
	SimpleDateFormat sdf= new SimpleDateFormat("yyyy-MM-dd");
	Date date=new Date();// 取时间
	Calendar calendar = Calendar.getInstance(); 
 ...
 * @throws ParseException
 */
public static String getNextMonth(String startMoth) throws ParseException {
	SimpleDateFormat sdf= new SimpleDateFormat("yyyy-MM");
	Date date=new Date();// 取时间
	Calendar calendar = Calendar.getInstance(); 
	calendar.setTime(sdf.parse(startMoth)); 
 ...
 * @throws ParseException
 */
public static String getMonthFirstday(String moth) throws ParseException {
	SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM");
    SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
    String firstday;
    // 获取前月的第一天  
    Calendar cale = Calendar.getInstance();
    cale.setTime(sdf.parse(moth));
 ...
 * @throws ParseException
 */
public static String getMonthLastday(String moth) throws ParseException {
	SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM");
	SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
	String lastday;
	Calendar cale = Calendar.getInstance();
 ...
 * @throws ParseException
 */
public static String getNextYearAndMonth(String moth) throws ParseException {
    SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
    String nextYear;
    // 获取前月的第一天  
    Calendar calendar = Calendar.getInstance();
	calendar.setTime(format.parse(moth)); 
	calendar.add(Calendar.YEAR, 1);
	nextYear = format.format(calendar.getTime());
	return nextYear;
}
